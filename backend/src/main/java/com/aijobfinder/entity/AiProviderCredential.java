...
public class AiProviderCredential {
    ...
    private String providerType; // GEMINI, OPENAI, ANTHROPIC, CUSTOM

    @Column(nullable = false, length = 1024)
    @JsonIgnore
    private String encryptedApiKey;

    private String modelName; // e.g. gemini-1.5-flash, gemini-2.0-flash, gpt-4o, claude-3-5-sonnet

    private String baseUrl; // For custom or endpoint overrides
